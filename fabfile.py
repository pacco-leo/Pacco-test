...
def install():
    ...
    if exists(installDir, use_sudo=True):
        print "There is an existing Paccotest folder in this RaspberryPI"
        print "Please run an update command (To be implemented :)) or remove the /home/pi/PaccoTest dir on the RPI"
